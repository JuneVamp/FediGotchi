...
import { VPStats } from "./petRepresentation"
import { VPActivityRemoteRef, VPetRemoteRef, VPUserRemoteRef } from "./remoteRefs"

export interface ActivityRequest {
    activity : {id : string, name : string, serverURL : string},
    // TODO 4: activityPartner ?: {id : string, type : string, serverURL : string},
    activityPartnerType : string,
    activityPartnerId : string,
    activityPartnerServerURL : string,
}
